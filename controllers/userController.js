...
const updateProfile = async (req, res) => {
    ...
    try {
        ...
        const { userId, name, phone, username, address, dob, gender } = req.body
        ...
        await userModel.findByIdAndUpdate(userId, { name, phone,username, address: JSON.parse(address), dob, gender })
